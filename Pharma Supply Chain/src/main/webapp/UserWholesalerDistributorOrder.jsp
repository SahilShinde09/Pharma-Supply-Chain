...
<body>
	...
	ResultSet rs = null;%>
				...
				<%
					...
					ps = con.prepareStatement("select * from distributor_order where w_id=?",
...
//									System.out.println(it.next());
								...
								Order Pending<br>
								<a type="button" href="userWholesalerAccept_DOrder.jsp?do_id=<%=rs.getString(1)%>" class="btn btn-primary btn-sm">Accept</a>
								<% }  else
								 {%>
