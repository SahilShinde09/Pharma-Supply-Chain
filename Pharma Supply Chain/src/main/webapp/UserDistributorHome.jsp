...
<body>
		...
		<div class="site-navbar py-2">
			...
			<div class="container">
				<div class="d-flex align-items-center justify-content-between">
					<div class="logo">
						<div class="site-logo">
							<a href="UserDistributorHome.jsp" class="js-logo-clone">Pharma</a>
						</div>
					</div>
						...
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								...
								<li><a data-toggle="modal"
									data-target="#selectProductModal">Select Wholesaler</a></li>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="UserDistributorTrack.jsp" method="post">
						...
						<div class="modal fade" id="selectProductModal" tabindex="-1"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="UserDistributorPurchaseHome.jsp" method="post">
											...
											<div class="form-group">
												<label for="c_country" class="text-black">Country <span
													...
													<option value="1">Select a Wholesaler ID</option>
													<% while(rs.next()){ %>
			...
			<div class="container">
				<div class="row">
					<div class="title-section text-center col-12">
						<h2 class="text-uppercase">All Our Products</h2>
					</div>
				</div>
				<%!Connection con = null;
	...
	ResultSet rs = null;%>
				...
				<%
					...
					ps = con.prepareStatement("select * from dproduct where d_id=?", ResultSet.TYPE_SCROLL_SENSITIVE,
							ResultSet.CONCUR_UPDATABLE);
				...
				<div class="row">
					...
					<div class="col-sm-6 col-lg-4 text-center item mb-4">
						...
						<p class="price">
							W.Rs. <span id="price<%=rs.getString(1)%>" class="divpr"><%=rs.getString(4)%></span>
							
							<form action="updateDPPrice.jsp" method="post">
								D.Rs. <input class="my-1" type="text" name="dprice" value="<%=rs.getString(5) %>" >
								<input type="hidden" name="dp_id" value="<%=rs.getString(1) %>" >
