				...
				<div class="d-flex align-items-center justify-content-between">
					...
					<div class="main-nav d-none d-lg-block">
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								<li><a href="UseCustomerHome.jsp">Continue Shopping</a></li>
					...
					<div class="icons">
						<a href="#" class="icons-btn d-inline-block js-search-open"><span
							class="icon-search"></span></a> <a href="ccart.html"
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="UseCustomerHome.jsp">Home</a> <span class="mx-2 mb-0">/</span>
		...
		<div class="site-section">
			<div class="container">
				...
				<%
					...
					ps = con.prepareStatement("select * from customer where c_email_address=?",
					...
					if(rs.next())
					{
						...
						String c_country = rs.getString(2);
						String c_fname = rs.getString(3);
						String c_lname = rs.getString(4);
						String c_address = rs.getString(5);
						String c_state_country = rs.getString(6);
						String c_postal_zip = rs.getString(7);
						String c_email_address = rs.getString(8);
						String c_phone = rs.getString(9);
				%>
				<div class="row">
					<div class="col-md-12 mb-5 mb-md-0">
						...
						<div class="p-3 p-lg-5 border">
							...
							<form action="CustmoerOrderPlaceProcess.jsp" method="post">
						
							
							<input type="text" name="itemsJson" id="itemsJson">
							<input type="text" name="c_id" id="c_id" value="<%=c_id %>"/>
