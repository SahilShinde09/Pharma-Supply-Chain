					...
					<div class="main-nav d-none d-lg-block">
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								<li class="active"><a href="UserManufacturerHome.jsp">Home</a></li>
		...
		<div class="site-section bg-light">
			<div class="container">
				...
				<%
					...
					ps = con.prepareStatement("select * from mproduct where m_id=?",
					...
					<div class="col-md-12 block-3 products-wrap">
						<div class="nonloop-block-3 owl-carousel">
							...
							<div class="text-center item mb-4">
								<a href="shop-single.html"> <img src = "data:image/jpeg;base64,${imgBase}"
									alt="Image"></a>
								<h3 class="text-dark">
									<a href="shop-single.html"><%=rs.getString(2) %></a>
								</h3>
								<p class="price">Rs.<%=rs.getString(4) %></p>
							</div>
							<% } %>
