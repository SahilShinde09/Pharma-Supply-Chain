...
<body>
			...
			<div class="container">
				<div class="d-flex align-items-center justify-content-between">
					...
					<div class="icons">
						...
						<a class="btn btn-primary mx-3" role="button" href="index.jsp"><b><%=session.getAttribute("uname")%>
					...
					<div class="col-md-6">
						<div class="row mb-5">
							<div class="col-md-6 mb-3 mb-md-0">
								<a href="UserWholesalerHome.jsp"><button class="btn btn-outline-primary btn-md btn-block">Continue
									Shopping</button></a>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-7">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6 text-right">
										<strong class="text-black">Rs. <span id="total"></span> </strong>
									</div>
								</div>
								<!-- <div class="row mb-5">
									<div class="col-md-6">
	...
	else 
	{
    	for (item in cart) 
    	{
	        ...
	        mystr = `<tr>
	        <td class="product-name"><h2 class="h5 text-black">${name}</h2></td>
	        <td>Rs. ${price}</td>
	        <td>${qty}</td>
	        <td>Rs. ${price*qty}</td>
	        </tr>`;
