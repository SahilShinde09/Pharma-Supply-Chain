...
<body>
					...
					<div class="main-nav d-none d-lg-block">
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								<li class="active"><a href="UserDistributorHome.jsp">Home</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="title-section text-center col-12">
						<h2 class="text-uppercase"><%=request.getParameter("wo_country") %> All Wholesaler Products</h2>
					</div>
				</div>
				<%!Connection con = null;
	...
	ResultSet rs = null;%>
				...
				<%
					con = (Connection) application.getAttribute("mycon");
					String id= request.getParameter("wo_country");
					session.setAttribute("w_id", id);
					ps = con.prepareStatement("select * from wproduct where  w_id=?", ResultSet.TYPE_SCROLL_SENSITIVE,
							ResultSet.CONCUR_UPDATABLE);
					ps.setString(1, id);
					rs = ps.executeQuery();
				%>
