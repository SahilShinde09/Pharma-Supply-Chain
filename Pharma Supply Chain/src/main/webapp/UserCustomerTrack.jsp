...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="title-section text-center col-12">
						<h2 class="text-uppercase"><%=request.getParameter("co_id") %> All Customer Products</h2>
					</div>
				</div>
	...
	ResultSet rs = null;%>
				...
				<%
					...
					ps = con.prepareStatement("select * from customer_order_track where co_id=?",
							ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
					ps.setString(1, request.getParameter("co_id"));
					rs = ps.executeQuery();
				%>
