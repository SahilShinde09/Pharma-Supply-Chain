			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="UserDistributorHome.jsp">Home</a> <span class="mx-2 mb-0">/</span>
				...
				<div class="row">
					<div class="col-md-12 mb-5 mb-md-0">
						...
						<div class="p-3 p-lg-5 border">
							...
							<form action="DistributorOrderPlaceProcess.jsp" method="post">
						
							<input type="hidden" name="itemsJson" id="itemsJson">
							<input type="hidden" name="w_id" id="w_id" value="<%=session.getAttribute("w_id") %>"/>
